# Detailed research policy (preserved from AGENTS.md)
...
Consult `PROJECT_GOALS.md` when interpreting project scope; normal parent startup is defined in root `AGENTS.md`.
