...
def main() -> None:
    ...
    require(
        '#define RCSM_VERSION "0.6.3-generalisation-dev.2"' in runtime_source,
        "version runtime 0.6.3-generalisation-dev.2",
        checks,
    )
    require(
    ...
    if not args.static_only:
        ...
        require(b"0.6.3-generalisation-dev.2" in prx_path.read_bytes(), "version 0.6.3 intégrée au PRX", checks)
