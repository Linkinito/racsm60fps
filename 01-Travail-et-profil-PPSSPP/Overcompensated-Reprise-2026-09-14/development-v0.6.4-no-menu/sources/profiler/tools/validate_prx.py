...
def main() -> None:
    ...
    if not args.static_only:
        ...
        require(b"0.6.4-no-menu-dev.1" in prx_path.read_bytes(), "version 0.6.4 intégrée au PRX", checks)
