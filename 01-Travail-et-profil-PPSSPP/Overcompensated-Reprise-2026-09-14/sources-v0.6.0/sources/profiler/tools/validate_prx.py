...
def main() -> None:
    ...
    require(
        '#define RCSM_VERSION "0.6.0-global-experimental.1"' in runtime_source,
        "version runtime 0.6.0-global-experimental.1",
        checks,
    )
    require(
    ...
    if not args.static_only:
        ...
        require(b"0.6.0-global-experimental.1" in prx_path.read_bytes(), "version 0.6.0 intégrée au PRX", checks)
