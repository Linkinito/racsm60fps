...
(d/'runtime-symbols.json').write_text(json.dumps({'version':'0.6.1-metalis-integration-dev.2','prx_sha256':hashlib.sha256((p/'patch.prx').read_bytes()).hexdigest(),'symbols':syms,'metalis':rows},indent=2))
