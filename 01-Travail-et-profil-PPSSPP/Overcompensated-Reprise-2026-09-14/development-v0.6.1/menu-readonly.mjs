...
try {
 ...
 const b=Buffer.from((await req('memory.read',{address:144087296,size:1164,replacements:false})).base64,'base64');
 const base=b.readUInt32LE(1132); if(base!==152358144||b.readUInt16LE(1080)!==4||b.readUInt32LE(1160)!==1)throw Error('Binding changed');
